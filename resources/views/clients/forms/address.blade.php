...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->first('state_province') ? 'is-invalid' : '' }}" name="state_province"
                id="state_province" placeholder="Estado" value="{{ old('state_province', $client->state_province) }}">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control {{ $errors->first('country') ? 'is-invalid' : '' }}" name="country"
                id="country" placeholder="País" value="{{ old('country', $client->country) }}">
