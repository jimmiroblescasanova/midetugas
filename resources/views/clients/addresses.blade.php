            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('clients.address.store') }}" role="form" method="POST">
                            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="line_1" id="line_1" placeholder="Calle" value="{{ old('line_1') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="line_2" id="line_2" placeholder="Número exterior / edificio" value="{{ old('line_2') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="line_3" id="line_3" placeholder="Número interior / departamento" value="{{ old('line_3') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="locality" id="locality" placeholder="Municipio" value="{{ old('locality') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="city" id="city" placeholder="Ciudad" value="{{ old('city') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               ...
                                               name="zipcode" id="zipcode" placeholder="Código postal" value="{{ old('zipcode') }}">
